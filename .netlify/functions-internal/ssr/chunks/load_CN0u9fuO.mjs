...
import { f as fsCachePath, s as supportedImageTypes, g as getSrcPath, a as sharp } from './prerender_DwvKRvaP.mjs';
import 'magic-string';
...
const { getLoadedImage, getTransformedImage } = await (sharp
  ? import('./imagetools_3bMRSmJZ.mjs')
  : import('./codecs_BAaVtTaW.mjs'));
