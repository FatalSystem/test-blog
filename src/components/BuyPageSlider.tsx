...
const slides = [
  {
    ...
    style: "tablet:bg-[url('/images/slider/slider_one.webp')] bg-[url('/images/slider/slider_onemobile.webp')] tablet:h-[60vh] h-[40vh]"
  },
  {
    ...
    style: "tablet:bg-[url('/images/slider/slider_two.webp')] bg-[url('/images/slider/slider_twomobile.webp')] tablet:h-[60vh] h-[40vh]"
  },
  {
    ...
    style: "tablet:bg-[url('/images/slider/slider_three.webp')] bg-[url('/images/slider/slider_threemobile.webp')] tablet:h-[60vh] h-[40vh]"
  }
