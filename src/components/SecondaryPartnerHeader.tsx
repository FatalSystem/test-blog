        ...
        <div className="bg-[#262424] px-5 py-4 flex flex-row max-h-96 justify-between items-center z-20">
          ...
          <div className='lg:flex flex-row hidden  items-center justify-center'>
            <div className=' flex flex-row gap-5' >
              ...
              <a href={Pages.RESERVE} className={'w-28 tablet:w-52 2xl:w-80 text-md 2xl:text-xl 2xl:py-3 rounded-full py-2 font-avenir uppercase text-t-green border-2 transition duration-300 text-center bg-[rgba(192,242,12,0.10)] border-t-green hover:bg-t-green hover:text-t-off-black'}>Buy</a>
            </div>
          </div>
        </div>
      </header>
