...
const slides = [
  {
    ...
    style: "xl:bg-[url('/images/about/slideonedesktopxl.webp')] min-[800px]:bg-center min-[900px]:bg-[url('/images/about/slideonedesktop.webp')] tablet:bg-left tablet:bg-[url('/images/about/slideonetablet.webp')] bg-[url('/images/about/slideone.webp')] tablet:h-[90vh] mobilem:h-[85vh] h-[70vh]"
  },
  {
    // content: <p className={textStyle} >With <strong>Tennibot</strong>, that number goes down to <strong>almost zero</strong></p>,
    style: "lg:bg-[url('/images/about/slidetwodesktopxl.webp')] tablet:bg-[25%] min-[550px]:bg-[url('/images/about/slidetwotablet.webp')] tablet:bg-[url('/images/about/slidetwomobilexl.webp')]  bg-[url('/images/about/slidetwo.webp')] tablet:h-[90vh] mobilem:h-[85vh] h-[70vh]"
  },
  {
    ...
    style: "xl:bg-[url('/images/about/slidethreedesktopxl.webp')] lg:bg-[url('/images/about/slidethreedesktop.webp')] tablet:bg-[url('/images/about/slidethreetablet.webp')] bg-[url('/images/about/slidethree.webp')] tablet:h-[90vh] mobilem:h-[85vh] h-[70vh]"
  }
