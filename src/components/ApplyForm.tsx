        ...
        <div className='flex flex-col md:flex-row w-full md:gap-10 gap-5' >
            <FormField
                ...
                render={({ field }) => (
                    ...
                    <FormControl>
                        <Input {...form.register('resume')} type="file" className="flex flex-col file:rounded-full file:bg-t-off-white file:text-t-off-black file:px-4 file:py-1 file:border-0 file:mr-5 file:font-avenir" />
                    </FormControl>
                    <FormMessage />
                    </FormItem>
                )}
            ...
            {/* <FormField
                ...
                render={({ field }) => (
                    ...
                    <FormControl>
                        <Input {...form.register('coverLetter')} type="file" className="flex flex-col file:rounded-full file:bg-t-off-white file:text-t-off-black file:px-4 file:py-1 file:border-0 file:mr-5 file:font-avenir" />
                    </FormControl>
                    <FormMessage />
                    </FormItem>
                )}
