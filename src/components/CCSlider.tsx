...
const containerStyle = 'font-avenir text-t-off-white flex flex-col size-full justify-center '
const titleStyle = 'uppercase font-black text-3xl mb-5'
const h1Style = 'font-avenir font-black text-t-off-white lg:text-8xl md:text-7xl tablet:text-6xl text-5xl uppercase mt-10'

const slides = {
  coaches: [
    {
      content: <h1 className={h1Style} >For coaches</h1>,
      style: 'bg-[url(\'../src/assets/clubs-and-coaches/coaches.webp\')] md:h-[60vh] h-[90vh]'
    },
    {
      content:
  ...
  clubs: [
    {
      content: <h1 className={h1Style} >For clubs</h1>,
      style: 'bg-[url(\'../src/assets/clubs-and-coaches/clubs.webp\')] md:h-[60vh] h-[90vh]'
    },
    {
      content:
      <div className={containerStyle} >
  ...
  school: [
    {
      content: <h1 className={h1Style} >For schools</h1>,
      style: 'bg-[url(\'../src/assets/clubs-and-coaches/school.webp\')] md:h-[60vh] h-[90vh]'
    },
    {
      content:
      <div className={containerStyle} >
...
export default function CCSlider ({ type }: IProps): JSX.Element {
  return (
    <TSlider slides={slides[type]} contentContainerStyle="p-10 sm:w-[80%] h-full m-auto" dotContainerStyle="sm:inset-y-[83%]" />
  )
}
