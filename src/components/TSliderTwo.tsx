...
export function TSliderTwo ({ slides, contentContainerStyle, dotContainerStyle, dotContainerDesktopStyle, arrowsStyle, slideShades, arrowBreakpoint = 640, prevArrowStyle, nextArrowStyle, onIndexChangeCb }): JSX.Element {
